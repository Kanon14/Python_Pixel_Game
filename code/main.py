...
from sprites import Sprite, MonsterPatchSprite, AnimatedSprite, BorderSprite, CollidableSprite, TransitionSprite
...
class Game:
    ...
    def __init__(self):
        ...
        pygame.display.set_caption("Pixel Monster Game")
